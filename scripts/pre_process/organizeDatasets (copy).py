...
AWE_DIR = './datasets/awe/'
AWE_DATA_INFO_PATH = './datasets/awe/info.csv'
...
def organizeDatasetAWE(dir,writeCSVInfoPath):
	...
	trainSubjects,testSubjects = decideTrainOrTest()
	...
	with open(writeCSVInfoPath, 'w', newline='') as csvfile:
		fieldnames = ['earID', 'x','y','leftOrRight','w','h','accessories','overlap','hPitch','hYaw','hRoll','subject','split']
		writer = csv.DictWriter(csvfile, fieldnames=fieldnames)
